...
LDS registers `/dev/nbd0` as a block device via the NBD kernel driver. The Linux kernel treats it identically to a hard drive:
...
**LDS Implementation:** [[NBD Layer]] — how LDS exposes itself as a block device; [[RAID01 Explained]] — block distribution  
**Related Glossary:** [[Block Number]], [[NAS]], [[VFS]]
