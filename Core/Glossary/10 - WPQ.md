...
An internal thread-safe data structure combining a priority queue with a condition variable. Worker threads block on it (zero CPU) until a command is available, then wake and pop the highest-priority item.
