...
See [[../C++/02 - Smart Pointers]] — `weak_ptr` for non-owning references.
...
- [[../C++/06 - Virtual Functions]] — observer interface uses virtual functions
- [[../C++/02 - Smart Pointers]] — weak_ptr for safe observer references
- [[../C++/08 - STL Containers]] — vector of observers
