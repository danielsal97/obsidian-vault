...
- [[../C++/06 - Virtual Functions]] — strategy uses virtual dispatch
- [[../C++/04 - Templates]] — policy-based design is compile-time strategy
- [[../C++/02 - Smart Pointers]] — own strategy with unique_ptr
