...
See [[../C/04 - Structs and Unions]] — struct definitions go in headers so every `.cpp` gets the same layout.  
See [[../C++/04 - Templates]] — templates must be in headers (the compiler needs the full definition to instantiate).
