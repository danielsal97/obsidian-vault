...
LDS uses `ThreadPool` + `WPQ` for this. See [[../Design Patterns/05 - Command]] — work items are command objects (or lambdas).
...
```cpp
// Using semaphores (see Linux/06 - Semaphores):
...
- [[../Linux/04 - Threads - pthreads]] — pthread API
- [[../Linux/06 - Semaphores]] — producer/consumer with semaphores
- [[../Design Patterns/01 - Reactor]] — single-threaded event loop alternative
- [[../Design Patterns/05 - Command]] — work items in thread pool
