...
See [[../C/02 - Memory - malloc and free]] — `malloc` uses `mmap` for allocations > `MMAP_THRESHOLD` (~128KB).
...
- [[../C/05 - File IO]] — standard file I/O via open/read/write
- [[../Memory/01 - Process Memory Layout]] — how mmap regions appear in virtual address space
- [[../C/02 - Memory - malloc and free]] — malloc uses mmap internally for large allocations
