...
→ See [[DevOps/Build System]] for full Makefile details.
...
- [[DevOps/Build System]] — full Makefile reference
- [[DevOps/Docker Setup]] — Docker environment for Linux
- [[Components/Scheduler]] — C scheduler in ds/
- [[Components/Watchdog]] — C watchdog in ds/
- [[Architecture/Client-Server Architecture]] — Mac client setup
